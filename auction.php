	...
	*/
    ...
    echo "<table><tr><th>ID</th><th>Title</th><th>Picture</th><th>Higest Bid</th><th>Auction started</th><th>Auction ends</th><th>Description</th><th>Created by</th><th>Bids</th></tr>";
     ...
     while($row = $result->fetch_assoc()) {
		 ...
		 echo '<tr><td>' . $id. '</td><td>' . $title. '</td><td><div id="myDiv"><img src="img/' . $pic. '"></div></td><td>' . $higestbid. ' $' . '</td><td>' . $timestart. '</td><td><span id="timer">' . '</span></td><td width="400px">' . $desc. '</td><td>' . $user . '</td><td>' . $bids. "</td></tr>";
